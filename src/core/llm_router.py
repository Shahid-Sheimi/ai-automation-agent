    ...
    try:
        ...
        if intent == "track_packages":
            ...
            if update_data is None:
                return "Your profile update request could not be processed right now. Please try again later."

            return (
                f"Updated your {update_data.field_type} to"
                f" \"{update_data.field_value}\"."
            )
